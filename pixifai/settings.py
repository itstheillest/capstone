...
'''
# Allowed local origins (e.g., Vite on 5173, Next.js/React on 3000)
...
# Allow sending cookies or Authorization headers across domains
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # Added BASE_DIR / 'templates'
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
